...
var _a = forge.pki.rsa.generateKeyPair({ bits: 2048, algorithm: 'RSA256' }), publicKey = _a.publicKey, privateKey = _a.privateKey;
...
var jwkPublicKey = (0, pem_jwk_1.pem2jwk)(publicPem);
var public_key = fs.readFileSync(process.cwd() + '/src/certs/public.pem', 'utf8');
var kid = crypto.createHash('sha256').update(public_key).digest('base64');
var jwk = __assign(__assign({ alg: "RS256", use: "sig" }, jwkPublicKey), { kid: kid });
